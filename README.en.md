...
```bash
codex plugin marketplace add full-stack-plugins/plugins
...
Open Settings → Plugins → Create → Add plugin marketplace, enter `full-stack-plugins/plugins`, then install from the personal marketplace section.

### Kimi Code CLI

```text
/plugins marketplace https://raw.githubusercontent.com/full-stack-plugins/plugins/main/kimi-marketplace.json
```
